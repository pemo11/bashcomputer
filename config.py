...
class Config:
    ...
    llm_api_key: str = os.getenv("NVIDIA_API_KEY", "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")  # Replace with your actual NVIDIA API key or set NVIDIA_API_KEY environment variable
    ...
    allowed_commands: list = field(default_factory=lambda: [
        "cd", "cp", "ls", "cat", "find", "touch", "echo", "grep", "pwd", "mkdir", "wget", "sort", "head", "tail", "du", "df",
    ])
